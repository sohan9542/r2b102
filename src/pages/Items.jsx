      ...
      <Modal.Body>
        <div className="w-full pd rounded-xl">
          ...
          <div className="px-3 pb-5 flex items-center justify-around w-full">
            <button
              className="bg-pr uppercase cursor-pointer sw text-center text-xs lg:text-xl px-5 py-2 hover:bg-purp hover:text-white  rounded-md"
            >
              Yes
            </button>
            <button
...
const Items = ({  showpage, setShowpage,showModal }) => {
          ...
          <div className="items-bg  lg:px-4">
            ...
            <div className="py-2 px-3 lg:px-5">
              ...
              <div className="my-3 w-full rounded-2xl px-4  py-2 pd box-white">
                ...
                <h4 className=" uppercase font-light py-1">level : 1</h4>
